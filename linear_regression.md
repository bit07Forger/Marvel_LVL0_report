...
MSE is also commonly used as the loss function *during* training, not just after.![alt text](https://github.com/bit07Forger/images/blob/main/image/losscurve.png?raw=true)
---
